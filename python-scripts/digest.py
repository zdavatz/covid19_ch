...
def download_daenuprobst_data():
    download_file_to_data_folder(daenuprobst_cases_csv_url, probst_folder())
    download_file_to_data_folder(daenuprobst_fatalities_csv_url, probst_folder())
    download_file_to_data_folder(daenuprobst_complete_csv_url, probst_folder())
